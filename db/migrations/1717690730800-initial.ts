...
export class Initial1717690730800 implements MigrationInterface {
    name = 'Initial1717690730800'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."orders_status_enum" RENAME TO "orders_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('WAITING_PAYMENT', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CENCELLED', 'OVERDATE')`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "status" SET DEFAULT 'WAITING_PAYMENT'`);
        await queryRunner.query(`DROP TYPE "public"."orders_status_enum_old"`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum_old" AS ENUM('WAITING_PAYMENT', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CENCELLED')`);
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "status" DROP DEFAULT`);
