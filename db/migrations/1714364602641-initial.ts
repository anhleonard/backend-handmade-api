...
export class Initial1714364602641 implements MigrationInterface {
    name = 'Initial1714364602641'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "productName" character varying NOT NULL, "productCode" character varying NOT NULL, "description" character varying NOT NULL, "materials" character varying NOT NULL, "mainColors" character varying NOT NULL, "uses" character varying NOT NULL, "productionDate" TIMESTAMP, "expirationDate" TIMESTAMP, "isHeavyGood" boolean NOT NULL, "isMultipleClasses" boolean NOT NULL, "price" numeric(30,0) DEFAULT '0', "inventoryNumber" integer, "images" text, "discount" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addedById" integer, "storeId" integer, CONSTRAINT "UQ_3146a8c669fc3f362c02fa9e0ba" UNIQUE ("productCode"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
